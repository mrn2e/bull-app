 ...
 */class $ extends HTMLElement{connectedCallback(){const t=this.getAttribute("type")||"",n=this.getAttribute("opponent")||"";this.innerHTML=`
      <style>
        .event {
